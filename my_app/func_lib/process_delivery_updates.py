...
def process_delivery(run_dir=app_cfg["UPDATES_DIR"]):
    print('MAPPING>>>>>>>>>> ', run_dir + '\\' + app_cfg['XLS_AS_DELIVERY_STATUS'])
    ...
    my_map = build_sheet_map(app_cfg['XLS_AS_DELIVERY_STATUS'], sheet_map, 'XLS_AS_DELIVERY_STATUS', run_dir)
