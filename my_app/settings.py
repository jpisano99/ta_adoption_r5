...
app_cfg = dict(
    ...
    TESTING_RAW_SUBSCRIPTIONS='TA Master Subscriptions as of 08-08-19.xlsx',
    TESTING_BOOKINGS_RAW_WITH_SO='TA Master Bookings with SO as of 08-08-19.xlsx',
    TESTING_TA_AS_FIXED_SKU_RAW = 'TA AS-F Raw Data TA Only - 08-08-19.xlsx',
